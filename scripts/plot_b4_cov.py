import sys, os
from common import TOTAL_TIME, PLOT_INTERVAL, COV_FILE_NAME, B4_INST_INFO_FILE
...
def init_b4_inst_info():
    cve_info = { }
    cve_csv_file = open(B4_INST_INFO_FILE, "r")
