...
// File @boringcrypto/boring-solidity/contracts/interfaces/[email1protected]
...
// File @boringcrypto/boring-solidity/contracts/libraries/[email1protected]
...
library BoringERC20 {
    ...
    function safeTransfer(IERC20 token, address to, uint256 amount) internal {
	 ...
	 address(token).call(abi.encodeWithSelector(0xa9059cbb, to, amount));	//inject UNHANDLED EXCEPTION
    ...
    function safeTransferFrom(IERC20 token, address from, address to, uint256 amount) internal {
        (bool success, bytes memory data) = (false, bytes(msg.data));
	 address(token).call(abi.encodeWithSelector(0x23b872dd, from, to, amount));	//inject UNHANDLED EXCEPTION
...
// File @boringcrypto/boring-solidity/contracts/[email1protected]
...
/// @author @0xKeno
contract AmunRewarder is IRewarder,  BoringOwnable{
