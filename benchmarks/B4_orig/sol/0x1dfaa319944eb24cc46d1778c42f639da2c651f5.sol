...
contract LIZS is Ownable{
    ...
    uint32[5] public totalVipCount = [0,0,0,0,0];   //11111VIP11

    uint256 public vipBuyPool;  //VIP111
    uint256 public vipBuyPoolOut; //1111111eth
    uint256 public stakePool;  //111
    uint256 public stakeFee;  //11111fee,1111
    ...
    uint constant private vipExtraStakeRate = 10 ether; //11VIP11111
